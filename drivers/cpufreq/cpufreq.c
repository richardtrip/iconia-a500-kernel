...
#define CPUMVMIN 770
#if defined(CONFIG_TEGRA_OVERCLOCK)
int cpufrequency[FREQCOUNT]  = { 1504000, 1400000, 1200000, 1000000, 912000, 816000, 760000, 750000, 608000, 456000, 312000, 216000 };
#else
int cpufrequency[FREQCOUNT]  = { 1200000, 1000000, 912000, 816000, 760000, 750000, 608000, 456000, 312000, 216000 };
#endif

#if defined(CONFIG_TEGRA_OVERCLOCK)
int cpuvoltage[FREQCOUNT] = { 1325, 1250, 1225, 1125, 1100, 1050, 1000, 975, 900, 825, 770, 770 };
#else
